        ...
        <header className="h-16 bg-card/60 backdrop-blur-md border-b border-border flex items-center justify-between px-8 z-10 sticky top-0 shadow-sm">
          <div className="flex items-center gap-4">
            {showBackButton && (
              <button
                onClick={() => router.back()}
                className="p-1.5 hover:bg-black/5 active:scale-95 rounded-lg transition-all text-secondary hover:text-text flex items-center justify-center cursor-pointer border border-border"
                title="Go Back"
              >
                <ArrowLeft size={16} />
              </button>
