...
export default function ProfileLanding() {
  const options = [
    {
      name: "Students",
      description: "Manage student accounts, registration details, and platform access.",
      href: "/dashboard/profile/students",
      icon: Users,
      color: "blue"
    },
    {
      name: "Mentors",
      description: "Access mentor directories, status verification, and level configurations.",
      href: "/dashboard/profile/mentors",
      icon: ShieldCheck,
      color: "green"
    }
  ];
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-black text-text tracking-tight">Profile Directory</h1>
        <p className="text-secondary mt-1 font-medium">Select a user role directory to manage</p>
      </div>
