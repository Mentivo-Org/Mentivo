...
export default function CommunicationLanding() {
  const options = [
    {
      name: "Admin-Side",
      description: "Manage outbound communications such as email updates and push notifications.",
      href: "/dashboard/communication/admin",
      icon: ShieldCheck,
      color: "blue"
    },
    {
      name: "Chat Moderation",
      description: "Review and moderate live chat messages, reports, and participant logs.",
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-black text-text tracking-tight">Communication Portal</h1>
        <p className="text-secondary mt-1 font-medium">Select a communications segment to manage</p>
      </div>
